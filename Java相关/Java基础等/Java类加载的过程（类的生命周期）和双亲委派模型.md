...
![](https://xieruhua.gitee.io/images/JavaLearning/Java相关/Java基础等/Java类加载的过程（类的生命周期）和双亲委派模型/类加载的七个阶段.png)
</center>
...
![](https://xieruhua.gitee.io/images/JavaLearning/Java相关/Java基础等/Java类加载的过程（类的生命周期）和双亲委派模型/类型加载器分类.png)
</center>
...
![](https://xieruhua.gitee.io/images/JavaLearning/Java相关/Java基础等/Java类加载的过程（类的生命周期）和双亲委派模型/Tomcat自定义的类加载器.png)  
`Tomcat加载器架构图`
</center>
...
![](https://xieruhua.gitee.io/images/JavaLearning/Java相关/Java基础等/Java类加载的过程（类的生命周期）和双亲委派模型/mysql-spi文件地址.png)
</center>
